...
import { buildSpecs } from './config/openapi';
...
// OpenAPI spec + the public-documentation filter live in ./config/openapi so
// they can be imported (and asserted) without booting this server. The live
// API is untouched by them: `publicSpec` only ever reaches `/openapi.json`
// and `/docs`. See docs/API_DOCUMENTATION.md.
const { published: publicSpec } = buildSpecs();
